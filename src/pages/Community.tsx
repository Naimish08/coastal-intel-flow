...
const Community = () => {
  const topContributors = [
    {
      ...
      reports: 247,
      verified: 239,
      badges: ['Veteran Reporter', 'Storm Tracker', 'Accuracy Expert'],
    ...
    },
    {
      ...
      reports: 189,
      verified: 181,
      badges: ['Community Leader', 'Safety Advocate'],
      avatar: '/api/placeholder/40/40',
      joinDate: '2022-07-22',
    },
    {
      ...
      reports: 156,
      verified: 155,
      badges: ['Research Partner', 'Technical Expert'],
      avatar: '/api/placeholder/40/40',
      joinDate: '2021-11-08',
    },
  ];
  ...
  const communityStats = [
    { label: 'Active Contributors', value: '3,421', icon: Users, color: 'text-primary' },
    { label: 'Total Reports', value: '12,467', icon: MessageSquare, color: 'text-success' },
    { label: 'Verified Reports', value: '11,089', icon: Shield, color: 'text-success' },
    { label: 'Countries', value: '156', icon: Globe, color: 'text-accent' },
  ];

  const recentActivity = [
    {
      user: 'Captain John Torres',
      action: 'reported severe storm conditions',
      location: 'Gulf of Mexico',
      time: '12 minutes ago',
      type: 'report',
    },
    {
      user: 'Marine Safety Team',
      action: 'verified navigation hazard',
    ...
    {
      user: 'Lisa Chen',
      action: 'earned Storm Tracker badge',
      location: 'Pacific Northwest',
      time: '1 hour ago',
      type: 'achievement',
    },
    {
      user: 'Coast Guard Station',
      action: 'issued safety alert based on community reports',
